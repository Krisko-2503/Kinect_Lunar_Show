...
namespace KinectLunnar
{
    public partial class MainWindow : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            // Apply glow effect to OverlayHost
            OverlayHost.Effect = glowEffect;
        }
        ...
        private void Sensor_SkeletonFrameReady(object sender, SkeletonFrameReadyEventArgs e)
        {
            using (SkeletonFrame frame = e.OpenSkeletonFrame())
            {
                ...
                {
                    RedrawFrame(skeletons, GetGlowEffect());
                }));
            }
        }

        private DropShadowEffect GetGlowEffect()
        {
            return glowEffect;
        }

        private void RedrawFrame(Skeleton[] skeletons, DropShadowEffect particleGlowEffect)
        {
        ...
        private void DrawGlowingSkeleton(DrawingContext dc, Skeleton skel)
        {
            ...
            var headJoint = skel.Joints[JointType.Head];
            if (headJoint.TrackingState == JointTrackingState.Tracked)
            {
                Point headPos = MapPoint(headJoint.Position);
                dc.DrawEllipse(
                    brush, // Fill: cyan
                    null,  // No outline
                    headPos,
